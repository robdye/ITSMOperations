...
export class WorkflowEngine {
  ...
  private async runStep(
    ...
    // update_incident. This injection tells the agent to actually fire its
    // tools.
    const triggerMode = (status.context.triggerMode as string | undefined) || 'propose';
    const isAuto = triggerMode === 'auto';
    const stepIsNotify = /notify|comms|notif/i.test(stepDef.id);
